...
function typeGuardSectorProps(option, props) {
	...
	return _objectSpread$13(_objectSpread$13(_objectSpread$13({}, props), option), {}, {
		cx,
		cy
	});
}
...
var _excluded2$2 = ["value", "background"];
...
var RadialBar = /*#__PURE__*/ function(_PureComponent) {
	...
	return _createClass$11(RadialBar, [
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				var _this2 = this;
				var _this$props2 = this.props, shape = _this$props2.shape, activeShape = _this$props2.activeShape, activeIndex = _this$props2.activeIndex, cornerRadius = _this$props2.cornerRadius, others = _objectWithoutProperties$4(_this$props2, _excluded$4);
				var baseProps = filterProps(others, false);
				return sectors.map(function(entry, i) {
					var isActive = i === activeIndex;
					var props = _objectSpread$12(_objectSpread$12(_objectSpread$12(_objectSpread$12({}, baseProps), {}, { cornerRadius: parseCornerRadius(cornerRadius) }, entry), adaptEventsOfChild(_this2.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(RadialBarSector, _extends$10({}, props, { key: "sector-".concat(i) }));
				});
			}
		},
		{
			...
			value: function renderSectorsWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$12(_objectSpread$12({}, entry), {}, { endAngle: interpolator(t) });
					});
					return /*#__PURE__*/ import_react.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
				});
			}
		...
		},
		{
			...
			value: function renderBackground(sectors) {
				...
				return sectors.map(function(entry, i) {
					entry.value;
					var background = entry.background, rest = _objectWithoutProperties$4(entry, _excluded2$2);
					if (!background) return null;
					var props = _objectSpread$12(_objectSpread$12(_objectSpread$12(_objectSpread$12(_objectSpread$12({ cornerRadius: parseCornerRadius(cornerRadius) }, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
						index: i,
...
_defineProperty$15(RadialBar, "displayName", "RadialBar");
_defineProperty$15(RadialBar, "defaultProps", {
	angleAxisId: 0,
	radiusAxisId: 0,
	minPointSize: 0,
	hide: false,
...
_defineProperty$15(RadialBar, "getComposedData", function(_ref2) {
	...
	return {
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$12(_objectSpread$12(_objectSpread$12(_objectSpread$12({}, entry), backgroundSector), {}, {
				payload: entry,
...
//#endregion
export { XAxis as a, Pie as c, ResponsiveContainer as d, Tooltip as f, YAxis as i, PolarAngleAxis as l, PieChart as n, Bar as o, BarChart as r, RadialBar as s, RadialBarChart as t, Cell as u };
